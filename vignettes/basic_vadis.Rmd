...
Next we simply loop over the datasets in `data_list` and fit the model. We'll use the `stand()` function to center and rescale our model inputs [see @Gelman2008]. 
